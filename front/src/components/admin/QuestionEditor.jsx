        ...
        <div style={{ width: "40vw" }}>
          ...
          <div style={{ display: "inline-block", marginLeft: "10px" }}>
            ...
            <Tooltip show={tooltipShow.imgTooltip}>
              1. <strong>Image url</strong> from web ( https://images.unsplash.com/photo-164... )
              <br />
        ...
        <div>
          ...
          <Preview id="preview">
            ...
            >
              <div style={{ height: "45%", marginBottom: "3%" }}>
                {value && (
                  <div style={{ height: "100%" }}>
                    <img
                      draggable={false}
                      src={value.url || "/image/Default.png"}
                      style={{ height: "70%" }}
                    />
                    <div
                      dangerouslySetInnerHTML={{
                        __html: DOMPurify.sanitize(value.source) || "<h5>소스코드입력</h5>",
                      }}
              ...
              <img
                draggable={false}
                src="/image/Answer_the_question.png"
                style={{ height: "8%" }}
              />
            </div>
          </Preview>
